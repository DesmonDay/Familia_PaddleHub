...
@moduleinfo(
    name="lda_webpage",
    version="1.0.0",
    summary="This is a PaddleHub Module for LDA topic model in webpage dataset, where we can calculate doc distance, calculate the similarity between query and document, etc.",
    author="baidu",
    author_email="",
